...
import { Modal, Button, Form, Select, Tag, Avatar, Checkbox, Input } from 'antd';
// import PersonPlusFillIcon from '@/utils/AppIcons';
    ...
    >
      <div className="mt-2">
        <Form form={form} onFinish={onFinish} colon={false}>
          <div className=" items-center mb-6 space-x-3 px-3" gutter={24}>
            <div
              className="flex-grow"
              ...
              {savedValues?.map((member) => (
                ...
                >
                  <Avatar
                    ...
                    src={member?.photoUrl || member?.publicResourceUrl}
                  >
...
AddFollowerPopUpModel.defaultProps = {
  suggestedValues: [],
...
AddFollowerPopUpModel.propTypes = {
  /**
...
export default connect()(Form.create()(AddFollowerPopUpModel));
