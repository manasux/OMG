          ...
          <div className="">
            ...
            <div className="">
              ...
              <Form
                ...
                onFinish={(val) => {
                  const newVal = val;
                  newVal.emailAddress = decodedToken?.emailAddress;
                  newVal.inviteToken = token;

                  dispatch({
                    type: 'vendor/setPassword',
                    payload: {
                      body: newVal,
                    },
                  }).then((res) => {
...
export default connect(({ loading }) => ({ loading: loading.effects['vendor/acceptVendor'] }))(
  InvitesUser,
);
