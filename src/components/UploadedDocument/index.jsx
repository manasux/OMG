...
const UploadedDocument = ({ fileList, setFileList, removeDocument }) => {
    ...
    <div className="w-full pl-4 pr-4">
      {fileList?.map((uploadedDoc) => (
        <div
          ...
          key={uploadedDoc.id}
        >
          <div className="p-2">{AppIcons.uploadedImg()}</div>
          ...
          <div className="flex items-center px-2">
            <div>
              <Icon
                component={AppIcons.PreviewIcon}
                onClick={() => {
